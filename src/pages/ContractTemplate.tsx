...
export default function ContractTemplate() {
  ...
  return (
    <>
      ...
      <div className="min-h-[297mm] flex flex-col p-6 font-sans text-[9.5pt] leading-normal bg-white w-[210mm] mx-auto print:p-0"
          ...
          <div className="mb-4 pb-2 border-b-2 border-black">
            <div className="flex justify-between items-center">
              ...
              <div className="flex-1 text-center">
                <h1 className="text-[13.5pt] font-bold">CONTRAT DE LOCATION N° {contract.numero_contrat}</h1>
              </div>
              <div className="text-[8.5pt] text-gray-600">
        ...
        <table className="w-full border-collapse mb-3">
          <thead>
            <tr>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">LOCATAIRE</th>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">2ÈME CONDUCTEUR</th>
            </tr>
          </thead>
          <tbody>
            <tr>
        ...
        <table className="w-full border-collapse mb-3">
          <thead>
            <tr>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">VÉHICULE</th>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">LOCATION</th>
            </tr>
          </thead>
          <tbody>
            <tr>
        ...
        {contract.prolongations && contract.prolongations.length > 0 && (
          <table className="w-full border-collapse mb-3">
            <thead>
              <tr>
                <th className="bg-yellow-100 border border-yellow-600 p-1 text-center font-bold text-[8.5pt]">
                  PROLONGATION(S)
                </th>
              </tr>
            </thead>
              ...
              <tr>
                <td className="border border-black p-2">
                  {contract.prolongations.map((p: any, i: number) => {
                    ...
                    return (
                      <div key={i} className="text-[8.5pt] mb-1">
        ...
        {vehicleChanges && vehicleChanges.length > 0 && (
          <table className="w-full border-collapse mb-3">
            <thead>
              <tr>
                <th className="bg-orange-100 border border-orange-600 p-1 text-center font-bold text-[8.5pt]">
              ...
              <tr>
                <td className="border border-black p-2">
                  {vehicleChanges.map((change: any, idx: number) => (
                    <div key={change.id} className="text-[8.5pt] mb-1">
        ...
        <table className="w-full border-collapse mb-3">
          <thead>
            <tr>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">ÉTAT DE VÉHICULE</th>
              <th className="bg-gray-300 border border-black p-1 text-center font-bold text-[9.5pt] w-1/2">OBSERVATIONS</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className="border border-black p-2 h-40 align-top">
                <div className="text-[8.5pt]">{contract.delivery_notes || contract.notes || ''}</div>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="text-center text-[8.5pt] italic mb-3">
        ...
        <div className="flex justify-between mt-4 mb-3 gap-4">
          <div className="w-[32%] text-center">
            ...
            <div className="border-t border-black pt-1 text-[8.5pt]">
